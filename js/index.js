...
exports.mustNotBeNull = mustNotBeNull;
exports.mustNotBeUndefined = mustNotBeUndefined;
exports.mustNotBeNullOrUndefined = mustNotBeNullOrUndefined;
exports.arrayMustNotBeEmpty = arrayMustNotBeEmpty;
exports.isLeapYear = isLeapYear;
exports.numberMustBeMax = numberMustBeMax;
exports.numberMustBeMin = numberMustBeMin;
exports.numberMustBeStrictlyMax = numberMustBeStrictlyMax;
exports.numberMustBeStrictlyMin = numberMustBeStrictlyMin;
exports.objectMustNotBeEmpty = objectMustNotBeEmpty;
exports.stringMustBeAtLeastNCharacters = stringMustBeAtLeastNCharacters;
exports.stringMustBeDifferentTo = stringMustBeDifferentTo;
exports.stringMustBeSIREN = stringMustBeSIREN;
exports.stringMustBeSIRET = stringMustBeSIRET;
exports.stringMustBeSimilarTo = stringMustBeSimilarTo;
exports.stringMustBeValidEmail = stringMustBeValidEmail;
exports.stringMustBeValidIPv4 = stringMustBeValidIPv4;
exports.stringMustContainWords = stringMustContainWords;
exports.stringMustNotBeEmpty = stringMustNotBeEmpty;
exports.stringMustBeZipCode = stringMustBeZipCode;
...
function arrayMustNotBeEmpty(value) {
  return Array.from(value).filter(elt => elt !== undefined).length > 0;
}
